-- Actualiza el prompt del agente de captura para que guíe el flujo, responda dudas y use ciudad.
UPDATE agent_configs
SET
  description = 'Guía el flujo conversacional de alquiler con referencia: hace las preguntas, responde dudas (ej. "qué es cuenta ajena?") y normaliza respuestas. Usa las herramientas enviar_mensaje o completar_paso.',
